...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/hooks/imgChange.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = handleImgInputChange;
...
function handleImgInputChange(e) {
  ...
  base_image.onload = function () {
    var img = _app.canvas.querySelector("#canvaImg"); // img.style.display = "block"
    // img.src = inputValue


    _app.canvas.style.backgroundImage = "url(".concat(inputValue, ")");
  };
}
},{"../app":"src/app.js"}],"src/hooks/textChange.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = handleTextInputChange;

var _app = require("../app");

function handleTextInputChange(e) {
  var colorInput = _app.d.querySelector(".sidebar__colorInput");

  var fontsizeInput = _app.d.querySelector(".sidebar__fontsizeInput"); // Remove old text 👇


  _app.d.querySelectorAll(".text").forEach(function (el) {
    return el.remove();
  }); // Create new text 👇
  ...
  var p = _app.d.createElement("p");

  p.classList.add("text");
  p.style.color = colorInput.value;
  p.style.fontSize = fontsizeInput.value + "px";
  p.textContent = inputValue; // Change fontsize, family and color on input changes 👇

  colorInput.addEventListener("input", function (e) {
    return p.style.color = e.target.value;
  });
  fontsizeInput.addEventListener("input", function (e) {
    return p.style.fontSize = e.target.value + "px";
  });

  _app.canvas.appendChild(p);
}
},{"../app":"src/app.js"}],"node_modules/html2canvas/dist/html2canvas.js":[function(require,module,exports) {
var define;
...
},{}],"src/hooks/dowloadPost.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = downloadPost;
...
function downloadPost(downloadButton) {
  (0, _html2canvas.default)(_app.canvas, {
    allowTaint: true
  }).then(function (canva) {
...
},{"html2canvas":"node_modules/html2canvas/dist/html2canvas.js","../app":"src/app.js"}],"src/app.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.canvas = exports.w = exports.d = void 0;

var _imgChange = _interopRequireDefault(require("./hooks/imgChange"));

var _textChange = _interopRequireDefault(require("./hooks/textChange"));

var _dowloadPost = _interopRequireDefault(require("./hooks/dowloadPost"));
...
var d = document;
exports.d = d;
var w = window; // DOM select

exports.w = w;
var canvas = d.querySelector("#canvasBox");
exports.canvas = canvas;
var imgInput = d.querySelector("#imgInput");
var sentenceInput = d.querySelector("#sentenceInput");
var dowloadBtn = d.querySelector(".sidebar__dowloadBtn"); // Events

imgInput.addEventListener("change", _imgChange.default);
sentenceInput.addEventListener("input", _textChange.default);
dowloadBtn.addEventListener("click", function (e) {
  return (0, _dowloadPost.default)(e.target);
});
},{"./hooks/imgChange":"src/hooks/imgChange.js","./hooks/textChange":"src/hooks/textChange.js","./hooks/dowloadPost":"src/hooks/dowloadPost.js"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
